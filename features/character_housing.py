...
class DormRoomCharacterMixin():
    ...
    def at_object_creation(self):
        ...
        # Create Dorm Room
        room = create_object(rooms.Room, key="{}'s Room".format(self.key))
        # Assign char as owner
        # Assign Room to location
...
-Special Exit Object that takes you to a house at the location

-Character for creating house on creation
-Exit Obj to enter house
