"""
Container
This is an Object Mixin and a series of commands to 'get', 'drop', and 'give' 
the contents of other objects.

INSTALLATION:
1.  Override the vanilla 'get', 'drop', and 'give' commands
    from features.object_container import CmdContainerGet, CmdContainerDrop, CmdContainerGive
    ...
    class CharacterCmdSet(default_cmds.CharacterCmdSet):
        ...
        def at_cmdset_creation(self):
            ...
            self.add(detail_system.CmdContainerDrop)
            self.add(detail_system.CmdContainerGive)

2. Have Object typeclass inherit from ContainerObjectMixin
    from features.object_container import ContainerObjectMixin
    class Object(ContainerObjectMixin, DefaultObject):
        pass

TODO:
-Permissions for Give, Drop, Take
"""

import evennia
from typeclasses.objects import Object
from django.conf import settings
from evennia.utils.utils import list_to_string, class_from_module

COMMAND_DEFAULT_CLASS = class_from_module(settings.COMMAND_DEFAULT_CLASS)

class CmdContainerGet(COMMAND_DEFAULT_CLASS):
    """
    ...
    Example:
        1. get wooden sword
        2. get big book from old bookshelf
    """
    key = "get"
    aliases = ["grab", "take"]
    rhs_split = ("=", " from ")
...
class CmdContainerDrop(COMMAND_DEFAULT_CLASS):
    """
...
class CmdContainerGive(COMMAND_DEFAULT_CLASS):
    """
...
class ContainerObjectMixin(Object):
    """
...
class Stash(ContainerObjectMixin):
    """
